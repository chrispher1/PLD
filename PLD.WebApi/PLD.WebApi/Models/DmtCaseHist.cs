...
{
    public partial class DmtCaseHist
    {
        public DmtCaseHist()
        {
            DmtCaseAddCovHist = new HashSet<DmtCaseAddCovHist>();
            DmtCaseLifeParticHist = new HashSet<DmtCaseLifeParticHist>();
            DmtCaseRsvpHist = new HashSet<DmtCaseRsvpHist>();
        }
        ...
        public DateTime? StatusReasonC { get; set; }
